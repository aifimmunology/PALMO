...
#' matrix. It must consist column Sample, Participant sample name; PTID, participant;
#' Time, longitudinal time frame; group,
...
dimUMAPPlot <- function(ann=NULL, rnaObj=NULL, countMat=NULL, nPC=30, gene_oi=NULL, groupName=NULL, plotname=NULL, filePATH=NULL, fileName=NULL) {
