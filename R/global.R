utils::globalVariables(c("CV", "cv", "Freq", "PTID", "Sample", "Time", "UMAP_1",
                         ...
                         "includeGroup", "clusterBy", "binom.test", "pnorm",
                         "signP", "z", "direction", "label", "group_oi",
                         "na.omit", "time", "blank", "gene", "filter.NA",
                         "filter.std", "standardise", "standardise2", "mestimate",
                         "mfuzz", "mfuzz.plot", "bygroup", "rainbow", "feature",
                         "variable"))
