...
#' @param SD_threshold Standard deviation limit to find outliers (Eg.
#' SD_threshold= 2, equals to Mean+/-2SD)
...
#' @param SD_threshold Standard deviation limit to find outliers (Eg. SD_threshold=
...
longitudinalDynamics <- function(metadata=NULL, data=NULL, datatype=NULL, omics=NULL,
    ...
    method="spearman", clusterBy="donor", SD_threshold=2,
