...
#' object/metadata should have Sample column curesponding to Annotation dataframe.
...
createPALMOobject <- function(anndata, data) {
  ...
  cat(date(),": The PALMO object is created\n")
  ...
  cat(date(),": For outout files, the output directory is created\n")
