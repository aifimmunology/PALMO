...
#' @param filePATH User-defined output directory \emph{PATH} to load the \emph{CV}
...
#' #Check PALMO object <result$var_genes>
#' }

VarFeatures <- function(data_object, group_oi=NULL,
  ...
  if(!is.null(data_object@result$cv_meanthreshold)) {
    ...
    stop(date(),": Please run cvCalcSC function before VarFeatures function\n")
  }
