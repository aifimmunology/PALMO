...
genecircosPlot <- function(data, geneList, groupColumn=NULL, groupBy=NULL, colorThreshold=NULL) {
    ...
    data_mat <- t(data_mat)
    col_fun1 = colorRamp2(c(0,0.001, colorThreshold,(colorThreshold+0.1),(colorThreshold+50)), c("grey","blue","white","pink","red"))
    ...
    circos.heatmap(data_mat, col = col_fun1, split=data_annotation$group, rownames.side = "outside", na.col = "grey", bg.border="black") #, track.height = 0.4)
